...
int main(int argc, char *argv[])
{
    ...
    struct sensors_db *sens_db = sensors_db_open(DB_FILE, SENSORS_DB_PRODUCER, DB_DATA_SIZE);
    ...
    while (keep_running)
    {
        ...
        {
            sensor_tick = 0;
            sensors_update(bmp280_sens, htu21d_sens, sens_db,
                           &temperature, &humidity, &bmp280_temp,
                           &bmp280_pressure, verbose);
        }
